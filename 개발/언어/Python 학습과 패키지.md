...
확인일: 2026-08-06  
예시는 **Python 3.10+** 감각. 3.8 이하·Python 2는 신규 학습에서 제외한다.
...
프로젝트마다 venv를 새로 만드는 습관이 사고를 줄인다.
...
| 권장 | 비권장 |
|------|--------|
| venv + requirements | 글로벌 pip에 전부 설치 |
...
**1주** — 문법, list/dict, 함수, venv, `pathlib`, `requests`로 API 하나 호출  
